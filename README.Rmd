...
* `mutRate(M, afreq)`: Computes the overall mutation rate, given by the formula `1 - sum p_i m_ii`, where `p_i` is the population frequency of allele `i` and `m_ii` is the non-mutation probability for allele `i`.
